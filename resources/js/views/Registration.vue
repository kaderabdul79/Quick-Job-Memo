<template>
    <div id="register" class="h-100 bg-blue-lighten-1 pa-3 rounded">
        <v-sheet width="500" class="mx-auto">
            <div class="text-h3 bg-blue-darken-2 text-center py-4">Registration</div>
            <v-form class="pa-3" fast-fail @submit.prevent="handleRegistration">
                ...
                <v-text-field v-model="user.password_confirmation" label="Confirm Password"></v-text-field>
